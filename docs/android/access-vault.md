...
![How to lock a vault with Android](../img/android/lock-vault-4-finish.png){:style="width: 346px"}
...
To change the name of a specific file or folder in Cryptomator, you select the `V` next to the file or folder ① and choose _Rename_ ②.
...
To move a file or a folder into another folder, you select the `V` next to the file or folder ① and choose _Move_ ②.
...
To delete a specific file or folder in Cryptomator, you select the `V` next to the file or folder ① and choose _Delete_ ②.
...
To export a specific file or folder in Cryptomator, you select the `V` next to the file or folder ① and choose _Export_ ②.
...
You select the file(s) to share by long clicking on it ①. Press the share button ② to choose to share these file(s) and select _Cryptomator_ ③.
