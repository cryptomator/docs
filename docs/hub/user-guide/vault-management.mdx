...
<Image src="/img/hub/vaultlist.png" alt="List vaults" width="2880" height="1800" />
...
:::note[Emergency Access Status in Vault List (Enterprise only)]
...
:::note
Creating vaults require the `create-vault` role. [Here](../admin-guide/user-group-management.mdx#roles) you can read more about roles.
:::
...
If the [Emergency Access](../admin-guide/emergency-access.mdx) feature is enabled, the following step appears:
...
<Image src="/img/hub/create-vault-emergency-access.png" alt="Define Emergency Access Conditions" width="2880" height="1640" />
...
<Image src="/img/hub/create-vault-recoverykey.png" alt="Save vault recoverykey" width="2880" height="1640" />
...
<Image src="/img/hub/create-vault-download.png" alt="Download vault template" width="2880" height="1240" />
...
<Image src="/img/hub/vault-details-user.png" alt="Display vault details as user" width="2880" height="1800" />

With the owner role, you have access to the following sections:

<Image src="/img/hub/vault-details-owner.png" alt="Display vault details as vault owner" width="2880" height="1800" />
...
<Image src="/img/hub/update-permission.png" alt="Update permissions in the vault details" width="2880" height="1800" />
...
<Image src="/img/hub/wot-carol-unverified.png" alt="Carol is unverified regarding her Web of Trust state" width="2880" height="1800" />
...
<Image src="/img/hub/wot-carol-verify.png" alt="Verify Carol regarding her Web of Trust state" width="2880" height="1800" />

`carol` is now verified

<Image src="/img/hub/wot-carol-verified.png" alt="Carol is verified regarding her Web of Trust state" width="2880" height="1800" />
...
You can read more details about Web of Trust and how to configure its settings in the [Admin section of Hub](../admin-guide/web-of-trust.mdx).
