...
* **New vaults:** During vault creation, use the `Define Emergency Access Conditions` step.
  For the full workflow, see [Vault Management](../user-guide/vault-management.mdx#create-a-vault).
* **Existing vaults:** Open `Vault Details` and [configure Emergency Access](../user-guide/vault-management.mdx#emergency-access-council).

## Configure Global Defaults {/* #admin-settings */}
...
See [Emergency Access Audit Log events](audit-logs.mdx#event-type-emergency-access).
