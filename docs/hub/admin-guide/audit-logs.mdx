...
- **User Keys Change** – A user changed their keys. This happens, for example, when the user [finished the account setup](../user-guide/your-account.mdx#account-setup).
